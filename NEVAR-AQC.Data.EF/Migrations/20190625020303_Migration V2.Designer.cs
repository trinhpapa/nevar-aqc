...
namespace NEVAR_AQC.Data.EF.Migrations
{
    ...
    [Migration("20190625020303_Migration V2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NEVAR_AQC.Core.Entities.IDTRImplementerEntity", b =>
                {
                    b.HasOne("NEVAR_AQC.Core.Entities.SYSUserEntity", "CRESYSUserEntity")
                        .WithMany("CREIDTRImplementerEntities")
                        .HasForeignKey("CreatedBy");

                    b.HasOne("NEVAR_AQC.Core.Entities.SYSUserEntity", "DELSYSUserEntity")
                        .WithMany("DELIDTRImplementerEntities")
                        .HasForeignKey("DeletedBy");

                    b.HasOne("NEVAR_AQC.Core.Entities.SYSUserEntity", "MODSYSUserEntity")
                        .WithMany("MODIDTRImplementerEntities")
                        .HasForeignKey("ModifiedBy");
            ...
            modelBuilder.Entity("NEVAR_AQC.Core.Entities.IDTRTestPropertyEntity", b =>
                {
                    b.HasOne("NEVAR_AQC.Core.Entities.SYSUserEntity", "CRESYSUserEntity")
                        .WithMany("CREIDTRTestPropertyEntities")
                        .HasForeignKey("CreatedBy");

                    b.HasOne("NEVAR_AQC.Core.Entities.SYSUserEntity", "DELSYSUserEntity")
                        .WithMany("DELIDTRTestPropertyEntities")
                        .HasForeignKey("DeletedBy");

                    b.HasOne("NEVAR_AQC.Core.Entities.SYSUserEntity", "MODSYSUserEntity")
                        .WithMany("MODIDTRTestPropertyEntities")
                        .HasForeignKey("ModifiedBy");
            ...
            modelBuilder.Entity("NEVAR_AQC.Core.Entities.IDTestRequirementEntity", b =>
                {
                    b.HasOne("NEVAR_AQC.Core.Entities.SYSUserEntity", "CRESYSUserEntity")
                        .WithMany("CREIDTestRequirementEntities")
                        .HasForeignKey("CreatedBy");

                    b.HasOne("NEVAR_AQC.Core.Entities.SYSUserEntity", "DELSYSUserEntity")
                        .WithMany("DELIDTestRequirementEntities")
                        .HasForeignKey("DeletedBy");

                    b.HasOne("NEVAR_AQC.Core.Entities.SYSUserEntity", "MODSYSUserEntity")
                        .WithMany("MODIDTestRequirementEntities")
                        .HasForeignKey("ModifiedBy");
            ...
            modelBuilder.Entity("NEVAR_AQC.Core.Entities.SYSCustomerEntity", b =>
                {
                    b.HasOne("NEVAR_AQC.Core.Entities.SYSUserEntity", "CRESYSUserEntity")
                        .WithMany("CRESYSCustomerEntities")
                        .HasForeignKey("CreatedBy");
                    ...
                    b.HasOne("NEVAR_AQC.Core.Entities.SYSUserEntity", "DELSYSUserEntity")
                        .WithMany("DELSYSCustomerEntities")
                        .HasForeignKey("DeletedBy");

                    b.HasOne("NEVAR_AQC.Core.Entities.SYSUserEntity", "MODSYSUserEntity")
                        .WithMany("MODSYSCustomerEntities")
                        .HasForeignKey("ModifiedBy");
                });
            ...
            modelBuilder.Entity("NEVAR_AQC.Core.Entities.SYSRequirementInvoiceEntity", b =>
                {
                    b.HasOne("NEVAR_AQC.Core.Entities.SYSUserEntity", "CRESYSUserEntity")
                        .WithMany("CRESYSRequirementInvoiceEntities")
                        .HasForeignKey("CreatedBy");
                    ...
                    b.HasOne("NEVAR_AQC.Core.Entities.SYSUserEntity", "DELSYSUserEntity")
                        .WithMany("DELSYSRequirementInvoiceEntities")
                        .HasForeignKey("DeletedBy");
                    ...
                    b.HasOne("NEVAR_AQC.Core.Entities.SYSUserEntity", "MODSYSUserEntity")
                        .WithMany("MODSYSRequirementInvoiceEntities")
                        .HasForeignKey("ModifiedBy");
            ...
            modelBuilder.Entity("NEVAR_AQC.Core.Entities.SYSRoleFunctionEntity", b =>
                {
                    b.HasOne("NEVAR_AQC.Core.Entities.SYSUserEntity", "CRESYSUserEntity")
                        .WithMany("CRESYSRoleFunctionEntities")
                        .HasForeignKey("CreatedBy");

                    b.HasOne("NEVAR_AQC.Core.Entities.SYSUserEntity", "DELSYSUserEntity")
                        .WithMany("DELSYSRoleFunctionEntities")
                        .HasForeignKey("DeletedBy");
                    ...
                    b.HasOne("NEVAR_AQC.Core.Entities.SYSUserEntity", "MODSYSUserEntity")
                        .WithMany("MODSYSRoleFunctionEntities")
                        .HasForeignKey("ModifiedBy");
